...
router.use(express.static(path.resolve(__dirname, 'project')));
...
router.get('/get/html', function(req, res) {
  ...
  var stylesheet = xslt.readXsltFile('movies.xsl');
  var doc = xslt.readXmlFile('movies.xml');
...
router.post('/post/json', function(req, res) {
  ...
  function appendJSON(obj) {
    ...
    var XMLformated = js2xmlparser("movies", JSONformated);
